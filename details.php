...
// on cas d'absence de paramètre dans l'uri, on rédirige la requête vers la page d'accueil
if (empty($_GET['movie_id'])) {
    header('Location: index.php');
    exit();
}
// on nettoie le paramètre
    ...
    <div class="single container">
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="grid g-2">
                    <!-- les videos sont affichés dépuis Youtube avec la clé fournie par l'API -->
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-related-movies" role="tabpanel" aria-labelledby="pills-related-movies-tab">
                        <?php if (empty($movie['similar']['total_results'])) : ?>
                            <p>Aucun film similaire n'est trouvé</p>
                        <?php else : ?>
                            ...
                            <div class="similar">
                                <?php foreach ($movie['similar']['results'] as $similar_movie) :  ?>
                                    <?php if ($similar_movie['poster_path']) : ?>
                                        <div class="mx-1">
                                            <img class="img-thumbnail img-fluid" src="http://image.tmdb.org/t/p/w185<?= $similar_movie['poster_path'] ?>" alt="poster <?= $similar_movie['title']; ?>">
                                            <p><a class="btn btn-outline-danger text-uppercase" href="?movie_id=<?= $similar_movie['id'] ?>">détails</a></p>
                                            <p><i class="fas fa-star text-warning me-1"></i><?= $similar_movie['vote_average'] ?></p>
                                        </div>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </div>
